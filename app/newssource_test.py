...
class NewsourceTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    '''
    self.new_News = News('abc-news','ABC News','Your trusted source for breaking news, analysis, exclusive interviews, headlines, and videos at ABCNews.com.','https://abcnews.go.com')
